...
global.sudo  =  process.env.SUDO || "918787651195" ;          // DON'T REMOVE
...
module.exports = {
  ...
  botname: process.env.BOT_NAME       || 'Mr Bot',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `Awmtea Polythene`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || 'Awmtea Polythene',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "Mr Bot" ,          // ADD YOUR STICKER PACKNAME
